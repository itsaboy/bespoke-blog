...
export const createGalleryPagePost = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: "Content created successfully", galleryPage });
  } catch (error) {
...
export const getGalleryPagePosts = async (req, res) => {
  try {
...
export const deleteGalleryPagePost = async (req, res) => {
...
export const checkGalleryPagePostExists = async (req, res) => {
  try {
