            ...
            <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
              ...
              <div className="relative flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                <img
                  src={about3}
                  alt=""
                  className="aspect-[7/5] w-[37rem] max-w-none flex-none rounded-2xl bg-gray-50 object-cover shadow-neon shadow-pink-600/80 border-2 border-pink-400"
                />
                <div className="absolute bg-gradient-to-r from-pink-400 to-pink-600 opacity-40 aspect-[7/5] w-[37rem] max-w-none rounded-2xl object-cover"/>
              </div>
